...
yarr_128 = np.array([x[2] for x in arr_128])
yarr_256 = np.array([x[2] for x in arr_256])
yarr_512 = np.array([x[2] for x in arr_512])
yarr_1024 = np.array([x[2] for x in arr_1024])
